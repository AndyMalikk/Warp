          ...
          <form onSubmit={handleCreateProject}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full bg-darkSecondary text-white rounded-lg px-4 py-2 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-accent"
                required
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={handleNewProjectChange}
                rows="4"
                className="w-full bg-darkSecondary text-white rounded-lg px-4 py-2 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-accent resize-none"
                required
              />
            </div>
